...
Download the latest version for [**Windows**](https://github.com/UBA-PSI/klausur-booklets/releases/download/v1.2.0/booklet-tool-1.2.0-windows-portable-x64.zip) · [**macOS**](https://github.com/UBA-PSI/klausur-booklets/releases/download/v1.2.0/Booklet.Tool-1.2.0.dmg) · [**Linux**](https://github.com/UBA-PSI/klausur-booklets/releases/tag/v1.2.0) and get started right away. [**Download test data**](https://github.com/UBA-PSI/klausur-booklets/releases/download/v1.2.0/booklet-tool-testdata.zip) to try out the tool's features.
