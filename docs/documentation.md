...
Clear instructions are essential for student success and to ensure the Booklet Tool can process the files correctly. Provide guidelines covering:
...
*   **Submission Process:**
    ...
    *   Recommend **PDF** as the submission format for best results with the Booklet Tool.
